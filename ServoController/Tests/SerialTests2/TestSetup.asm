...
//rjmp ThisTest
    ...
    RunTest TestSerialProcessCommandSetMultipleServoPosnSetsRealCommandLength

    RunTest TestSerialProcessCommandSetMultipleServoPosnTooManyServosToSet

    RunTest TestSerialProcessCommandSetMultipleServoPosnTwoServosFirstInvalid

    RunTest TestSerialProcessCommandSetMultipleServoPosnTwoServosSecondInvalid

    RunTest TestSerialProcessCommandSetMultipleServoPosnTwoServosFirstPosnInvalid

    RunTest TestSerialProcessCommandSetMultipleServoPosnTwoServosSecondPosnInvalid

    RunTest TestSerialProcessCommandSetMultipleServoPosnCalculateFactorsLoopComplete

    RunTest TestSerialProcessCommandSetMultipleServoPosnCalculateFactors

    RunTest TestSerialProcessCommandSetMultipleServoPosnSortStart

    RunTest TestSerialProcessCommandSetMultipleServoPosnAfterValidation

    RunTest TestSerialProcessCommandSetMultipleServoPosnThreeServos100x50x25

    RunTest TestSerialProcessCommandSetMultipleServoPosnThreeServosOneWithZeroSteps

    RunTest TestSerialProcessCommandSetMultipleServoPosnTwoServos100x77

    RunTest TestSerialProcessCommandSetMultipleServoPosn2SetsRealCommandLength

    RunTest TestSerialProcessCommandSetMultipleServoPosn2ThreeServos100x50x25MinStep10

ThisTest:

    RunTest TestSerialProcessCommandSetMultipleServoPosn2ThreeServos249x0x0MinStep6

    RunTest TestSerialProcessCommandSetMultipleServoPosn3SetsRealCommandLength

    RunTest TestSerialProcessCommandSetMultipleServoPosn3ThreeServos100x50x25MinStep10MinFreq20
...
.include "SerialTests-SetMultipleServoPosn.asm"
.include "SerialTests-SetMultipleServoPosn2.asm"
.include "SerialTests-SetMultipleServoPosn3.asm"
.include "Mocks.asm"
